...
# Reactive output ---------------------------------------------------------
  ...
  output$violinPlot<-renderPlot({
    ...
    res()%>%
      ...
      scale_x_discrete(labels= c("Infectious Patient","Susceptible patient 1", "Susceptible patient 2"))+
      xlab("")+
      labs(
        title="Airborne concentration",
        subtitle="Comparison between patient sessions",
        caption="1st patient is infecitous, 2nd/3rd patients are susceptible"
      ) +
